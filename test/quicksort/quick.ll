...
entry:
  ...
  %1 = sdiv i32 %0, 2
  %2 = load i32*, i32** %A
  %elePtr = getelementptr inbounds i32, i32* %2, i32 %1
  %tmpvar = load i32, i32* %elePtr
...
cond9:                                            ; preds = %loop10, %loop
  ...
  %3 = load i32*, i32** %A
  %elePtr13 = getelementptr inbounds i32, i32* %3, i32 %LoadInst12
  %tmpvar14 = load i32, i32* %elePtr13
...
cond19:                                           ; preds = %loop20, %afterLoop11
  ...
  %5 = load i32*, i32** %A
  %elePtr24 = getelementptr inbounds i32, i32* %5, i32 %LoadInst23
  %tmpvar25 = load i32, i32* %elePtr24
...
if:                                               ; preds = %afterLoop21
  ...
  %7 = load i32*, i32** %A
  %elePtr33 = getelementptr inbounds i32, i32* %7, i32 %LoadInst32
  %tmpvar34 = load i32, i32* %elePtr33
  store i32 %tmpvar34, i32* %y
  %LoadInst35 = load i32, i32* %i
  %8 = load i32*, i32** %A
  %elePtr36 = getelementptr inbounds i32, i32* %8, i32 %LoadInst35
  %LoadInst37 = load i32, i32* %j
  %9 = load i32*, i32** %A
  %elePtr38 = getelementptr inbounds i32, i32* %9, i32 %LoadInst37
  %tmpvar39 = load i32, i32* %elePtr38
  store i32 %tmpvar39, i32* %elePtr36
  %LoadInst40 = load i32, i32* %j
  %10 = load i32*, i32** %A
  %elePtr41 = getelementptr inbounds i32, i32* %10, i32 %LoadInst40
  %LoadInst42 = load i32, i32* %y
  store i32 %LoadInst42, i32* %elePtr41
...
loop9:                                            ; preds = %cond8
  ...
  %elePtr16 = getelementptr inbounds [1000000 x i32], [1000000 x i32]* %B, i32 0, i32 %LoadInst15
  %tmpvar = load i32, i32* %elePtr16
